  ...
  const content = {
    english: {
      ...
      paragraphs: [
        ...
        'Prof. Purohit\'s research work has been published in many prestigious international journals, including IEEE Transactions and IEEE Letters. Several of his invited lectures, video lectures, research presentations, and laboratory demonstrations are available online.'
      ]
    },
    hindi: {
      ...
      paragraphs: [
        ...
        'प्रो. पुरोहित का शोध कार्य IEEE Transactions और IEEE Letters सहित कई प्रतिष्ठित अंतरराष्ट्रीय पत्रिकाओं में प्रकाशित हुआ है। उनके कई आमंत्रित व्याख्यान, वीडियो व्याख्यान, शोध प्रस्तुतियां और प्रयोगशाला प्रदर्शन ऑनलाइन उपलब्ध हैं।'
      ]
    }
  };
